...
?>
  <table class="htmlmail-body">
    <tr><td style="padding:10px 0;font-size:20px;">Please click on the verification link below to verify your email address!</td></tr>
  </table>
  <div>
    <?php print $params['verification_link']; ?>
  </div>

  <table>
    <tr><td style="padding-top:20px;"><?php print $params['unsubscribe_link']; ?></td></tr>
    <tr><td><?php print $params['change_subscription_link']; ?></td></tr>
  </table>
  <div>
